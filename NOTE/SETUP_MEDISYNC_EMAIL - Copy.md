# Hướng dẫn cài đặt Email VetCare Store - NHANH CHÓNG ⚡
...
-- Import file: database/VetCare Store_email_config.sql
```
...
**Tên hiển thị:** `VetCare StoreNoreply`  
...
- `database/VetCare Store_email_config.sql` - Cấu hình SMTP
