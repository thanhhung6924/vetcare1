# HỆ THỐNG EMAIL VetCare Store ĐÃ ĐƯỢC ÁP DỤNG
...
**Email gửi:** VetCare Storenoreplybot@gmail.com  
...
- `database/VetCare Store_email_config.sql` - Cài đặt SMTP

## 🧹 Đã xóa file test:

✅ `test_real_email.php`  
✅ `test_simple_email.php`  
✅ `test_VetCare Store_email.php`  
