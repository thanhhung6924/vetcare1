...
- **Tác vụ dành cho Admin**: Chatbot hỗ trợ truy vấn dữ liệu (sản phẩm, đơn hàng, khách hnagf, …) bằng ngôn ngữ tự nhiên.
- **Tích hợp GPT API**: Nâng cao khả năng trả lời hội thoại và xử lý ngôn ngữ tự nhiên.
- **Quản lý dữ liệu**: Lưu trữ thông tin khách hàng, bác sĩ, đơn thuốc với **MySQL**.
